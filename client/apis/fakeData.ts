export const fakeProducts = [
  ...
  },
  {
    ...
    weight: 120,
    tasteProfile:
      'The flavor of a red banana can be rich and tropical, with hints of berry-like sweetness. Some people also note subtle undertones of raspberry or strawberry in its taste. The creamy texture of the red banana complements its sweet flavor, providing a delightful eating experience.',
    origin: 'Southeast Asia',
    randomFact:
      'Red bananas contain higher levels of vitamin C compared to their yellow counterparts. This makes them a good source of this essential nutrient, which plays a vital role in supporting the immune system, promoting collagen production, and aiding in iron absorption.',
  },
  {
    id: 3,
    name: 'Blue Java',
  ...
  },
  {
    ...
    weight: 140,
    tasteProfile:
      'The Berangan banana offers a delightful taste profile that is characteristic of many common banana varieties. It has a sweet and creamy flavor that is often described as mellow and balanced. The taste of the Berangan banana is not overly intense, making it enjoyable for those who prefer a more subtle banana flavor.',
    origin: 'Southeast Asia',
    randomFact:
      "The Berangan banana is a popular choice for its versatility in culinary applications. While it is commonly consumed fresh, it is also well-suited for cooking and baking. The Berangan banana's sweet and creamy flavor adds depth to desserts like banana bread, muffins, and pies.",
  },
  {
    id: 7,
    name: 'Goldfinger',
    ...
    weight: 170,
    tasteProfile:
      'The Goldfinger banana offers a distinctive and delicious taste profile. It is known for its sweet and tropical flavor with hints of tanginess. The taste of a Goldfinger banana is often described as a combination of pineapple and banana, providing a unique and enjoyable eating experience. Its flavor profile makes it a popular choice for those seeking a slightly different and more exotic taste compared to traditional banana varieties.',
    origin: 'Selective Breeding',
    randomFact:
      "The Goldfinger banana is not only valued for its taste and appearance but also for its resistance to the devastating Panama disease. It's resistance to Panama disease makes it an important cultivar that offers improved sustainability and helps ensure the availability of bananas for future generations.",
  },
  {
    id: 8,
    name: 'Praying Hands',
